...
**Version:** `0.19.1` (`C:\Coding\Claude\Launcher\VERSION` @ `0.19.1`, global `RULES.md` sha256 `8ba490ace894e56b6ad14c3cba648441ace475e44e96d02fa82db9bb57c8505e` verified ISS-115 against installed `C:\Users\popes\.config\opencode\AGENTS.md`)
...
**What is in flight:** adoption unit (desk steps 2–5 install, then SG-009 proof dispatch at step 6 through the new runner; held for desk queue per U2 + sign-off C; SG-009 amended `16bf439`, pushed). Phase 0 exit slices held until the transport migration lands (SG-010 drafted, untracked). Superseded note retired 2026-09-06: SG-007 landed and rated 98 long ago (receipt `d43f4c1`); the old BLOCKED-at-gate text described a state that no longer exists.
