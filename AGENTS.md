...
| **Harness** | OpenCode — **Class 4 procedure, wake proven 2026-09-11** | `HARNESSES.md` — background probe `3b96fc80` exit 0 arrived with harness resume (Class-1 shape observed); standing procedure keeps chunked status-verb checks until a dispatch rides the wake. Checks run the status verb, never the trigger log (`DISPATCH.md` §2c) |
